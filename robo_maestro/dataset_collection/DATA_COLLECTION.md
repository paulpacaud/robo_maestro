...
hf upload paulpacaud/ur5_close_drawer /home/ppacaud/docker_shared/data/ur5_close_drawer --repo-type dataset
...
# stack_yellow_cup_on_pink_cup
6 keysteps
---
1: start
2: approach the yellow cup
3: down, close gripper

4: lift the yellow cup
5: approach the pink plate
6: down, open gripper
