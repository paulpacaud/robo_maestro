...
class TaskEvaluator:
    def __init__(self, env, task, variation, instructions, episode_id, links_bbox_file_path, cam_list, image_size, server_addr):
        self.env = env
        self.task = task
        self.variation = variation
        self.instructions = instructions
        self.episode_id = episode_id
        self.links_bbox_file_path = links_bbox_file_path
    ...
    def execute_step(self, step_id, obs, keystep_real, cache):
        ...
        keystep_real = process_keystep(
            obs, 
            links_bbox_file_path=self.links_bbox_file_path,
...
def main():
    ...
    keystep_real = process_keystep(
        obs,
        links_bbox_file_path=links_bbox_file_path,
        cam_list=args.cam_list,
